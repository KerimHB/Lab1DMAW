                    ...
                    <form action="ejercicio2.jsp" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="interes">
                                ...
                                <option value="<%=i%>"><%=i%> - <%=i.getP()%></option>
                                <% } %>
                            </select>
                        </div>
                                    ...
                                    <%
                                        if (request.getParameter("EnviarInfo") != null || request.getParameter("LeerInfo") != null) {
                                            ...
                                            for (int i = 0; i < lCuenta.size(); i++) {%>
                                                <option class="form-control" value="<%=lCuenta.get(i).obtenerCuenta()%>"><%=lCuenta.get(i).obtenerCuenta()%></option>
                                            <%}
                                            }%>
            ...
            <% if (request.getParameter("LeerInfo") != null){%>
                <div>
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            <p class="card-text">Monto ingresado: <%=request.getParameter("monto")%></p>
                            ...
                            <p class="card-text">Tipo de interes: <%=cliente.obtenerTipoDeInteres()%> - <%=cliente.obtenerTipoDeInteres().getP()%></p>
                        </div>
                    </div>
                </div>
            <%}%>
